...
# Run after create_project.tcl, or use scripts/vivado_build.sh.

source [file join [file dirname [info script]] "config.tcl"]

# Single-threaded Vivado is slower but gives the best chance of repeatable results.
# Change this locally if you prefer speed over strict reproducibility.
