...
- `sw.abi` uses editable templates at `sw/programs/gpgpu_runtime.h.in` and `sw/programs/gpgpu.ld.in`; the generated header/linker artifacts are the active ABI inputs for program build goals.
